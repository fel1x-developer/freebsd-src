...
void cl_usage(void);
int sig_init(GS *, SCR *);
int cl_event(SCR *, EVENT *, uint32_t, int);
int cl_screen(SCR *, uint32_t);
int cl_quit(GS *);
...
int ex_pr(SCR *, EXCMD *);
int ex_print(SCR *, EXCMD *, MARK *, MARK *, uint32_t);
...
int ex_tag_free(SCR *);
int ex_txt(SCR *, TEXTH *, ARG_CHAR_T, uint32_t);
...
int v_txt(SCR *, VICMD *, MARK *,
   const CHAR_T *, size_t, ARG_CHAR_T, recno_t, u_long, uint32_t);
