...
/// device. This is either the EDID information retrieved from the
/// EFI_EDID_OVERRIDE_PROTOCOL if an override is available, or an identical copy
/// of the EDID information from the EFI_EDID_DISCOVERED_PROTOCOL if no
