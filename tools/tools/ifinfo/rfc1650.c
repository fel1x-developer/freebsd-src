...
print_1650(const void *xmd, size_t len)
{
	...
	print("Multiple-collision frames",
	    md->dot3StatsMultipleCollisionFrames);
	...
	print("Internal transmit errors",
	    md->dot3StatsInternalMacTransmitErrors);
...
#define cprint(num)                               \
	print("Packets with " #num " collisions", \
...
static const char *const amd[] = { 0, "Am7990", "Am79900", "Am79C940" };

static const char *const intel[] = { 0, "82586", "82596", "82557" };

static const char *const national[] = { 0, "8390", "Sonic" };

static const char *const fujitsu[] = { 0, "86950" };

static const char *const digital[] = { 0, "DC21040", "DC21140", "DC21041",
	"DC21140A", "DC21142" };

static const char *const westerndigital[] = { 0, "83C690", "83C790" };

#define vendor(name, sets)                                   \
	{                                                    \
		name, sets, (sizeof sets) / (sizeof sets[0]) \
	}
static struct {
	const char *name;
	const char *const *chips;
	size_t len;
} chipset_names[] = { { 0 }, vendor("AMD", amd), vendor("Intel", intel), { 0 },
	vendor("National Semiconductor", national), vendor("Fujitsu", fujitsu),
	vendor("Digital", digital), vendor("Western Digital", westerndigital) };
