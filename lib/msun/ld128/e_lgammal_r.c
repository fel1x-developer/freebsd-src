...
static const long double pi = 3.14159265358979323846264338327950288e+00L;
/*
 * Domain y in [0x1p-119, 0.28], range ~[-1.4065e-36, 1.4065e-36]:
 * |(lgamma(2 - y) + y / 2) / y - a(y)| < 2**-119.1
 */
static const long double a0 = 7.72156649015328606065120900824024296e-02L,
 ...
 */
static const long double tc = 1.46163214496836234126265954232572133e+00L,
 ...
 */
static const long double u0 = -7.72156649015328606065120900824024311e-02L,
 ...
 * with y = x - 2.
 */
static const long double s0 = -7.72156649015328606065120900824024297e-02L,
 ...
 */
static const long double w0 = 4.18938533204672741780329736405617738e-01L,
...
lgammal_r(long double x, int *signgamp)
{
	...
	*signgamp = 1 - 2 * (hx >> 15);
	...
	/* purge 1 and 2 */
	if ((ix == 0x3fff || ix == 0x4000) && (lx | llx) == 0)
		r = 0;
	/* for x < 2.0 */
	else if (ix < 0x4000) {
																								...
																								(t22 +
																									...
																									(t23 +
																										...
																										(t24 +
																										    y *
																											(t25 +
																											    y * (t26 + y * (t27 + y * (t28 + y * (t29 + y * (t30 + y * (t31 + y * t32))))))))))))))))))))))))))))));
			r += tf + p;
			break;
		case 2:
			p1 = y *
