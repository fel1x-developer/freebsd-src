...
static void
reportTime(int32 count, long clocks)
{
...
enum { numInputs_int32 = 32 };

static const int32 inputs_int32[numInputs_int32] = { 0xFFFFBB79, 0x405CF80F,
	0x00000000, 0xFFFFFD04, 0xFFF20002, 0x0C8EF795, 0xF00011FF, 0x000006CA,
	0x00009BFE, 0xFF4862E3, 0x9FFFEFFE, 0xFFFFFFB7, 0x0BFF7FFF, 0x0000F37A,
	0x0011DFFE, 0x00000006, 0xFFF02006, 0xFFFFF7D1, 0x10200003, 0xDE8DF765,
	0x00003E02, 0x000019E8, 0x0008FFFE, 0xFFFFFB5C, 0xFFDF7FFE, 0x07C42FBF,
	0x0FFFE3FF, 0x040B9F13, 0xBFFFFFF8, 0x0001BF56, 0x000017F6,
	0x000A908A };

static void
time_a_int32_z_float32(float32 function(int32))
{
...
static void
time_a_int32_z_float64(float64 function(int32))
{
	clock_t startClock, endClock;
	int32 count, i;
	int8 inputNum;
...
static void
time_a_int32_z_floatx80(floatx80 function(int32))
{
	clock_t startClock, endClock;
	int32 count, i;
	int8 inputNum;
...
static void
time_a_int32_z_float128(float128 function(int32))
{
	clock_t startClock, endClock;
	int32 count, i;
	int8 inputNum;
...
enum { numInputs_int64 = 32 };

static const int64 inputs_int64[numInputs_int64] = { LIT64(0xFBFFC3FFFFFFFFFF),
	LIT64(0x0000000003C589BC), LIT64(0x00000000400013FE),
	LIT64(0x0000000000186171), LIT64(0xFFFFFFFFFFFEFBFA),
	LIT64(0xFFFFFD79E6DFFC73), LIT64(0x0000000010001DFF),
	LIT64(0xDD1A0F0C78513710), LIT64(0xFFFF83FFFFFEFFFE),
	LIT64(0x00756EBD1AD0C1C7), LIT64(0x0003FDFFFFFFFFBE),
	LIT64(0x0007D0FB2C2CA951), LIT64(0x0007FC0007FFFFFE),
	LIT64(0x0000001F942B18BB), LIT64(0x0000080101FFFFFE),
	LIT64(0xFFFFFFFFFFFF0978), LIT64(0x000000000008BFFF),
	LIT64(0x0000000006F5AF08), LIT64(0xFFDEFF7FFFFFFFFE),
	LIT64(0x0000000000000003), LIT64(0x3FFFFFFFFF80007D),
	LIT64(0x0000000000000078), LIT64(0xFFF80000007FDFFD),
	LIT64(0x1BBC775B78016AB0), LIT64(0xFFF9001FFFFFFFFE),
	LIT64(0xFFFD4767AB98E43F), LIT64(0xFFFFFEFFFE00001E),
	LIT64(0xFFFFFFFFFFF04EFD), LIT64(0x07FFFFFFFFFFF7FF),
	LIT64(0xFFFC9EAA38F89050), LIT64(0x00000020FBFFFFFE),
	LIT64(0x0000099AE6455357) };

static void
time_a_int64_z_float32(float32 function(int64))
{
	clock_t startClock, endClock;
	int32 count, i;
	int8 inputNum;
...
static void
time_a_int64_z_float64(float64 function(int64))
{
	clock_t startClock, endClock;
	int32 count, i;
	int8 inputNum;
...
static void
time_a_int64_z_floatx80(floatx80 function(int64))
{
	clock_t startClock, endClock;
	int32 count, i;
	int8 inputNum;
...
static void
time_a_int64_z_float128(float128 function(int64))
{
	clock_t startClock, endClock;
	int32 count, i;
	int8 inputNum;
...
enum { numInputs_float32 = 32 };

static const float32 inputs_float32[numInputs_float32] = { 0x4EFA0000,
	0xC1D0B328, 0x80000000, 0x3E69A31E, 0xAF803EFF, 0x3F800000, 0x17BF8000,
	0xE74A301A, 0x4E010003, 0x7EE3C75D, 0xBD803FE0, 0xBFFEFF00, 0x7981F800,
	0x431FFFFC, 0xC100C000, 0x3D87EFFF, 0x4103FEFE, 0xBC000007, 0xBF01F7FF,
	0x4E6C6B5C, 0xC187FFFE, 0xC58B9F13, 0x4F88007F, 0xDF004007, 0xB7FFD7FE,
	0x7E8001FB, 0x46EFFBFF, 0x31C10000, 0xDB428661, 0x33F89B1F, 0xA3BFEFFF,
	0x537BFFBE };

static void
time_a_float32_z_int32(int32 function(float32))
{
	clock_t startClock, endClock;
	int32 count, i;
	int8 inputNum;
...
static void
time_a_float32_z_int64(int64 function(float32))
{
	clock_t startClock, endClock;
	int32 count, i;
	int8 inputNum;
...
static void
time_a_float32_z_float64(float64 function(float32))
{
	clock_t startClock, endClock;
	int32 count, i;
	int8 inputNum;
...
static void
time_a_float32_z_floatx80(floatx80 function(float32))
{
	clock_t startClock, endClock;
	int32 count, i;
	int8 inputNum;
...
static void
time_a_float32_z_float128(float128 function(float32))
{
	clock_t startClock, endClock;
	int32 count, i;
	int8 inputNum;
...
static void
time_az_float32(float32 function(float32))
{
	clock_t startClock, endClock;
	int32 count, i;
	int8 inputNum;
...
static void
time_ab_float32_z_flag(flag function(float32, float32))
{
	clock_t startClock, endClock;
	int32 count, i;
	...
	do {
		for (i = minIterations; i; --i) {
			function(inputs_float32[inputNumA],
...
static void
time_abz_float32(float32 function(float32, float32))
{
	clock_t startClock, endClock;
	int32 count, i;
	int8 inputNumA, inputNumB;
...
static const float32 inputs_float32_pos[numInputs_float32] = { 0x4EFA0000,
	0x41D0B328, 0x00000000, 0x3E69A31E, 0x2F803EFF, 0x3F800000, 0x17BF8000,
	0x674A301A, 0x4E010003, 0x7EE3C75D, 0x3D803FE0, 0x3FFEFF00, 0x7981F800,
	0x431FFFFC, 0x4100C000, 0x3D87EFFF, 0x4103FEFE, 0x3C000007, 0x3F01F7FF,
	0x4E6C6B5C, 0x4187FFFE, 0x458B9F13, 0x4F88007F, 0x5F004007, 0x37FFD7FE,
	0x7E8001FB, 0x46EFFBFF, 0x31C10000, 0x5B428661, 0x33F89B1F, 0x23BFEFFF,
	0x537BFFBE };

static void
time_az_float32_pos(float32 function(float32))
{
	clock_t startClock, endClock;
	int32 count, i;
	int8 inputNum;
...
static void
time_a_float64_z_int32(int32 function(float64))
{
	clock_t startClock, endClock;
	int32 count, i;
	int8 inputNum;
...
static void
time_a_float64_z_int64(int64 function(float64))
{
	clock_t startClock, endClock;
	int32 count, i;
	int8 inputNum;
...
static void
time_a_float64_z_float32(float32 function(float64))
{
	clock_t startClock, endClock;
	int32 count, i;
	int8 inputNum;
...
static void
time_a_float64_z_floatx80(floatx80 function(float64))
{
	clock_t startClock, endClock;
	int32 count, i;
	int8 inputNum;
...
static void
time_a_float64_z_float128(float128 function(float64))
{
	clock_t startClock, endClock;
	int32 count, i;
	int8 inputNum;
...
static void
time_az_float64(float64 function(float64))
{
	clock_t startClock, endClock;
	int32 count, i;
	int8 inputNum;
...
static void
time_ab_float64_z_flag(flag function(float64, float64))
{
	clock_t startClock, endClock;
	int32 count, i;
	int8 inputNumA, inputNumB;
	...
	do {
		for (i = minIterations; i; --i) {
			function(inputs_float64[inputNumA],
			    inputs_float64[inputNumB]);
...
static void
time_abz_float64(float64 function(float64, float64))
{
	clock_t startClock, endClock;
	int32 count, i;
	int8 inputNumA, inputNumB;
...
static void
time_az_float64_pos(float64 function(float64))
{
	clock_t startClock, endClock;
	int32 count, i;
	int8 inputNum;
...
enum { numInputs_floatx80 = 32 };

static const struct {
	bits16 high;
	bits64 low;
} inputs_floatx80[numInputs_floatx80] = { { 0xC03F, LIT64(0xA9BE15A19C1E8B62) },
...
static void
time_a_floatx80_z_int32(int32 function(floatx80))
{
	clock_t startClock, endClock;
	int32 count, i;
	int8 inputNum;
...
static void
time_a_floatx80_z_int64(int64 function(floatx80))
{
	clock_t startClock, endClock;
	int32 count, i;
	int8 inputNum;
...
static void
time_a_floatx80_z_float32(float32 function(floatx80))
{
	clock_t startClock, endClock;
	int32 count, i;
	int8 inputNum;
...
static void
time_a_floatx80_z_float64(float64 function(floatx80))
{
	clock_t startClock, endClock;
	int32 count, i;
	int8 inputNum;
...
static void
time_a_floatx80_z_float128(float128 function(floatx80))
{
	clock_t startClock, endClock;
	int32 count, i;
	int8 inputNum;
...
static void
time_az_floatx80(floatx80 function(floatx80))
{
	clock_t startClock, endClock;
	int32 count, i;
	int8 inputNum;
...
static void
time_ab_floatx80_z_flag(flag function(floatx80, floatx80))
{
	clock_t startClock, endClock;
	int32 count, i;
	int8 inputNumA, inputNumB;
...
static void
time_abz_floatx80(floatx80 function(floatx80, floatx80))
{
	clock_t startClock, endClock;
	int32 count, i;
	int8 inputNumA, inputNumB;
...
static const struct {
	bits16 high;
	bits64 low;
} inputs_floatx80_pos[numInputs_floatx80] = { { 0x403F,
...
static void
time_az_floatx80_pos(floatx80 function(floatx80))
{
	clock_t startClock, endClock;
	int32 count, i;
	int8 inputNum;
...
enum { numInputs_float128 = 32 };

static const struct {
	bits64 high, low;
} inputs_float128[numInputs_float128] = { { LIT64(0x3FDA200000100000),
...
static void
time_a_float128_z_int32(int32 function(float128))
{
	clock_t startClock, endClock;
	int32 count, i;
	int8 inputNum;
...
static void
time_a_float128_z_int64(int64 function(float128))
{
	clock_t startClock, endClock;
	int32 count, i;
	int8 inputNum;
...
static void
time_a_float128_z_float32(float32 function(float128))
{
	clock_t startClock, endClock;
	int32 count, i;
	int8 inputNum;
...
static void
time_a_float128_z_float64(float64 function(float128))
{
	clock_t startClock, endClock;
	int32 count, i;
	int8 inputNum;
...
static void
time_a_float128_z_floatx80(floatx80 function(float128))
{
	clock_t startClock, endClock;
	int32 count, i;
	int8 inputNum;
...
static void
time_az_float128(float128 function(float128))
{
	clock_t startClock, endClock;
	int32 count, i;
	int8 inputNum;
...
static void
time_ab_float128_z_flag(flag function(float128, float128))
{
	clock_t startClock, endClock;
	int32 count, i;
	int8 inputNumA, inputNumB;
...
static void
time_abz_float128(float128 function(float128, float128))
{
	clock_t startClock, endClock;
	int32 count, i;
	int8 inputNumA, inputNumB;
...
static const struct {
	bits64 high, low;
} inputs_float128_pos[numInputs_float128] = { { LIT64(0x3FDA200000100000),
						  LIT64(0x0000000000000000) },
	{ LIT64(0x3FFF000000000000), LIT64(0x0000000000000000) },
...
static void
time_az_float128_pos(float128 function(float128))
{
	clock_t startClock, endClock;
	int32 count, i;
	int8 inputNum;
...
static void
timeFunctionVariety(uint8 functionCode, int8 roundingPrecision,
    int8 roundingMode, int8 tininessMode)
{
	uint8 roundingCode;
	int8 tininessCode;
...
static void
timeFunction(uint8 functionCode, int8 roundingPrecisionIn, int8 roundingModeIn,
    int8 tininessModeIn)
{
	...
	for (;;) {
		...
		for (roundingMode = 1; roundingMode < NUM_ROUNDINGMODES;
		     ++roundingMode) {
			...
			for (tininessMode = 1; tininessMode < NUM_TININESSMODES;
			     ++tininessMode) {
				if ((roundingPrecision == 32) ||
				...
				timeFunctionVariety(functionCode,
...
main(int argc, char **argv)
{
	...
	while (argc && (argPtr = argv[0])) {
		...
		writeHelpMessage:
			...
			for (functionCode = 1; functionCode < NUM_FUNCTIONS;
			     ++functionCode) {
				if (strcmp(argPtr,
					functions[functionCode].name) == 0) {
					break;
				}
			}
			if (functionCode == NUM_FUNCTIONS) {
				fail("Invalid option or function `%s'",
				    argv[0]);
			}
			functionArgument = TRUE;
		}
	...
	if (functionCode) {
		...
		for (functionCode = 1; functionCode < NUM_FUNCTIONS;
			...
			if (functions[functionCode].numInputs == 1) {
				timeFunction(functionCode, roundingPrecision,
