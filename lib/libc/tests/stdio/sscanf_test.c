...
ATF_TC_BODY(sscanf_b, tc)
{
	...
	for (stc = sscanf_test_cases; *stc->input; stc++) {
		...
		SSCANF_TEST(input + 1, "%b", stc->b.ret, stc->b.val,
		    stc->b.len);
		input[0] = '+';
		SSCANF_TEST(input, "%b", stc->b.ret, stc->b.val,
...
ATF_TC_BODY(sscanf_o, tc)
{
	...
	for (stc = sscanf_test_cases; *stc->input; stc++) {
		strcpy(input + 1, stc->input);
		SSCANF_TEST(input + 1, "%o", stc->o.ret, stc->o.val,
		    stc->o.len);
		input[0] = '+';
		SSCANF_TEST(input, "%o", stc->o.ret, stc->o.val,
...
ATF_TC_BODY(sscanf_d, tc)
{
	...
	for (stc = sscanf_test_cases; *stc->input; stc++) {
		strcpy(input + 1, stc->input);
		SSCANF_TEST(input + 1, "%d", stc->d.ret, stc->d.val,
		    stc->d.len);
		input[0] = '+';
		SSCANF_TEST(input, "%d", stc->d.ret, stc->d.val,
...
ATF_TC_BODY(sscanf_x, tc)
{
	...
	for (stc = sscanf_test_cases; *stc->input; stc++) {
		strcpy(input + 1, stc->input);
		SSCANF_TEST(input + 1, "%x", stc->x.ret, stc->x.val,
		    stc->x.len);
		input[0] = '+';
		SSCANF_TEST(input, "%x", stc->x.ret, stc->x.val,
...
ATF_TC_BODY(sscanf_i, tc)
{
	...
	for (stc = sscanf_test_cases; *stc->input; stc++) {
		strcpy(input + 1, stc->input);
		SSCANF_TEST(input + 1, "%i", stc->i.ret, stc->i.val,
		    stc->i.len);
		input[0] = '+';
		SSCANF_TEST(input, "%i", stc->i.ret, stc->i.val,
