...
struct sigaltstack_args {
	char ss_l_[PADL_(const struct sigaltstack *)];
	const struct sigaltstack *ss;
	char ss_r_[PADR_(const struct sigaltstack *)];
	char oss_l_[PADL_(struct sigaltstack *)];
	struct sigaltstack *oss;
	char oss_r_[PADR_(struct sigaltstack *)];
};
struct ioctl_args {
	char fd_l_[PADL_(int)];
	int fd;
...
struct getgroups_args {
	char gidsetsize_l_[PADL_(int)];
	int gidsetsize;
	char gidsetsize_r_[PADR_(int)];
...
struct setgroups_args {
	...
	int gidsetsize;
	char gidsetsize_r_[PADR_(int)];
	char gidset_l_[PADL_(const gid_t *)];
	const gid_t *gidset;
	char gidset_r_[PADR_(const gid_t *)];
};
struct getpgrp_args {
	syscallarg_t dummy;
};
...
struct setitimer_args {
	...
	char itv_l_[PADL_(const struct itimerval *)];
	const struct itimerval *itv;
	char itv_r_[PADR_(const struct itimerval *)];
...
struct connect_args {
	...
	__socklen_t namelen;
	char namelen_r_[PADR_(__socklen_t)];
};
...
struct setsockopt_args {
	...
	__socklen_t valsize;
	char valsize_r_[PADR_(__socklen_t)];
};
struct listen_args {
	char s_l_[PADL_(int)];
	int s;
...
struct getsockopt_args {
	...
	__socklen_t *avalsize;
	char avalsize_r_[PADR_(__socklen_t *)];
};
struct readv_args {
	char fd_l_[PADL_(int)];
	int fd;
...
struct settimeofday_args {
	char tv_l_[PADL_(const struct timeval *)];
...
struct utimes_args {
	...
	const char *path;
	char path_r_[PADR_(const char *)];
	char tptr_l_[PADL_(const struct timeval *)];
	const struct timeval *tptr;
	char tptr_r_[PADR_(const struct timeval *)];
};
struct adjtime_args {
	char delta_l_[PADL_(const struct timeval *)];
	const struct timeval *delta;
	char delta_r_[PADR_(const struct timeval *)];
...
struct sigtimedwait_args {
	...
	const sigset_t *set;
	char set_r_[PADR_(const sigset_t *)];
	char info_l_[PADL_(struct siginfo *)];
	struct siginfo *info;
	char info_r_[PADR_(struct siginfo *)];
	char timeout_l_[PADL_(const struct timespec *)];
	const struct timespec *timeout;
	char timeout_r_[PADR_(const struct timespec *)];
};
...
struct futimesat_args {
	...
	const char *path;
	char path_r_[PADR_(const char *)];
	char times_l_[PADL_(const struct timeval *)];
	const struct timeval *times;
	char times_r_[PADR_(const struct timeval *)];
};
struct linkat_args {
...
struct futimens_args {
	...
	int fd;
	char fd_r_[PADR_(int)];
	char times_l_[PADL_(const struct timespec *)];
	const struct timespec *times;
	char times_r_[PADR_(const struct timespec *)];
};
...
struct kevent_args {
	...
	int fd;
	char fd_r_[PADR_(int)];
	char changelist_l_[PADL_(const struct kevent *)];
	const struct kevent *changelist;
	char changelist_r_[PADR_(const struct kevent *)];
...
struct fspacectl_args {
	...
	int cmd;
	char cmd_r_[PADR_(int)];
	char rqsr_l_[PADL_(const struct spacectl_range *)];
	const struct spacectl_range *rqsr;
	char rqsr_r_[PADR_(const struct spacectl_range *)];
	char flags_l_[PADL_(int)];
	int flags;
	char flags_r_[PADR_(int)];
	char rmsr_l_[PADL_(struct spacectl_range *)];
	struct spacectl_range *rmsr;
	char rmsr_r_[PADR_(struct spacectl_range *)];
};
...
struct swapoff_args {
	...
	const char *name;
	char name_r_[PADR_(const char *)];
	char flags_l_[PADL_(u_int)];
	u_int flags;
	char flags_r_[PADR_(u_int)];
};
struct kqueuex_args {
	char flags_l_[PADL_(u_int)];
	u_int flags;
...
struct membarrier_args {
	...
	int cmd;
	char cmd_r_[PADR_(int)];
	char flags_l_[PADL_(unsigned)];
	unsigned flags;
	char flags_r_[PADR_(unsigned)];
	char cpu_id_l_[PADL_(int)];
	int cpu_id;
	char cpu_id_r_[PADR_(int)];
};
struct timerfd_create_args {
	char clockid_l_[PADL_(int)];
	int clockid;
	char clockid_r_[PADR_(int)];
	char flags_l_[PADL_(int)];
	int flags;
	char flags_r_[PADR_(int)];
};
struct timerfd_gettime_args {
	...
	int fd;
	char fd_r_[PADR_(int)];
	char curr_value_l_[PADL_(struct itimerspec *)];
	struct itimerspec *curr_value;
	char curr_value_r_[PADR_(struct itimerspec *)];
};
struct timerfd_settime_args {
	...
	int flags;
	char flags_r_[PADR_(int)];
	char new_value_l_[PADL_(const struct itimerspec *)];
	const struct itimerspec *new_value;
	char new_value_r_[PADR_(const struct itimerspec *)];
	char old_value_l_[PADL_(struct itimerspec *)];
	struct itimerspec *old_value;
	char old_value_r_[PADR_(struct itimerspec *)];
};
struct kcmp_args {
	char pid1_l_[PADL_(pid_t)];
	pid_t pid1;
	char pid1_r_[PADR_(pid_t)];
	char pid2_l_[PADL_(pid_t)];
	pid_t pid2;
	char pid2_r_[PADR_(pid_t)];
	char type_l_[PADL_(int)];
	int type;
	char type_r_[PADR_(int)];
	char idx1_l_[PADL_(uintptr_t)];
	uintptr_t idx1;
	char idx1_r_[PADR_(uintptr_t)];
	char idx2_l_[PADL_(uintptr_t)];
	uintptr_t idx2;
	char idx2_r_[PADR_(uintptr_t)];
};
...
int sys_clock_getcpuclockid2(struct thread *,
    struct clock_getcpuclockid2_args *);
...
int sys_sched_get_priority_max(struct thread *,
    struct sched_get_priority_max_args *);
int sys_sched_get_priority_min(struct thread *,
    struct sched_get_priority_min_args *);
int sys_sched_rr_get_interval(struct thread *,
    struct sched_rr_get_interval_args *);
...
int sys_sctp_generic_sendmsg(struct thread *,
    struct sctp_generic_sendmsg_args *);
int sys_sctp_generic_sendmsg_iov(struct thread *,
    struct sctp_generic_sendmsg_iov_args *);
int sys_sctp_generic_recvmsg(struct thread *,
    struct sctp_generic_recvmsg_args *);
...
struct osendmsg_args {
	...
	int s;
	char s_r_[PADR_(int)];
	char msg_l_[PADL_(const struct omsghdr *)];
	const struct omsghdr *msg;
...
struct freebsd4_sigreturn_args {
	char sigcntxp_l_[PADL_(const struct freebsd4_ucontext *)];
	const struct freebsd4_ucontext *sigcntxp;
	char sigcntxp_r_[PADR_(const struct freebsd4_ucontext *)];
};
...
int freebsd4_getdomainname(struct thread *,
    struct freebsd4_getdomainname_args *);
int freebsd4_setdomainname(struct thread *,
    struct freebsd4_setdomainname_args *);
...
int freebsd10__umtx_unlock(struct thread *,
    struct freebsd10__umtx_unlock_args *);
...
struct freebsd11_kevent_args {
	...
	int fd;
	char fd_r_[PADR_(int)];
	char changelist_l_[PADL_(const struct freebsd11_kevent *)];
	const struct freebsd11_kevent *changelist;
	char changelist_r_[PADR_(const struct freebsd11_kevent *)];
	char nchanges_l_[PADL_(int)];
	int nchanges;
	char nchanges_r_[PADR_(int)];
	char eventlist_l_[PADL_(struct freebsd11_kevent *)];
	struct freebsd11_kevent *eventlist;
	char eventlist_r_[PADR_(struct freebsd11_kevent *)];
	char nevents_l_[PADL_(int)];
	int nevents;
	char nevents_r_[PADR_(int)];
	char timeout_l_[PADL_(const struct timespec *)];
...
int freebsd11_getdirentries(struct thread *,
    struct freebsd11_getdirentries_args *);
