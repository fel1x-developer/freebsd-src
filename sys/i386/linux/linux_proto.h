...
struct linux_execve_args {
	...
	char *path;
	char path_r_[PADR_(char *)];
	char argp_l_[PADL_(l_uintptr_t *)];
	l_uintptr_t *argp;
	char argp_r_[PADR_(l_uintptr_t *)];
	char envp_l_[PADL_(l_uintptr_t *)];
	l_uintptr_t *envp;
	char envp_r_[PADR_(l_uintptr_t *)];
};
...
struct linux_stat_args {
	...
	char *path;
	char path_r_[PADR_(char *)];
	char up_l_[PADL_(struct l_old_stat *)];
	struct l_old_stat *up;
	char up_r_[PADR_(struct l_old_stat *)];
};
...
struct linux_clone_args {
	...
	char stack_l_[PADL_(l_ulong)];
	l_ulong stack;
	char stack_r_[PADR_(l_ulong)];
	char parent_tidptr_l_[PADL_(l_int *)];
	l_int *parent_tidptr;
	char parent_tidptr_r_[PADR_(l_int *)];
	char tls_l_[PADL_(l_ulong)];
	l_ulong tls;
	char tls_r_[PADR_(l_ulong)];
	char child_tidptr_l_[PADL_(l_int *)];
	l_int *child_tidptr;
	char child_tidptr_r_[PADR_(l_int *)];
};
...
struct linux_poll_args {
	...
	char timeout_l_[PADL_(long)];
	long timeout;
	char timeout_r_[PADR_(long)];
};
...
struct linux_listxattr_args {
	...
	const char *path;
	char path_r_[PADR_(const char *)];
	char list_l_[PADL_(char *)];
	char *list;
	char list_r_[PADR_(char *)];
	char size_l_[PADL_(l_size_t)];
	l_size_t size;
	char size_r_[PADR_(l_size_t)];
};
...
struct linux_sys_futex_args {
	char uaddr_l_[PADL_(uint32_t *)];
	uint32_t *uaddr;
	char uaddr_r_[PADR_(uint32_t *)];
...
struct linux_ioprio_set_args {
	...
	char ioprio_l_[PADL_(l_int)];
	l_int ioprio;
	char ioprio_r_[PADR_(l_int)];
};
...
struct linux_rseq_args {
	char rseq_l_[PADL_(struct linux_rseq *)];
	struct linux_rseq *rseq;
	char rseq_r_[PADR_(struct linux_rseq *)];
	char rseq_len_l_[PADL_(uint32_t)];
	uint32_t rseq_len;
	char rseq_len_r_[PADR_(uint32_t)];
	char flags_l_[PADL_(l_int)];
	l_int flags;
	char flags_r_[PADR_(l_int)];
	char sig_l_[PADL_(uint32_t)];
	uint32_t sig;
	char sig_r_[PADR_(uint32_t)];
};
...
struct linux_clock_gettime64_args {
	...
	clockid_t which;
	char which_r_[PADR_(clockid_t)];
	char tp_l_[PADL_(struct l_timespec64 *)];
...
struct linux_clock_nanosleep_time64_args {
	...
	l_int flags;
	char flags_r_[PADR_(l_int)];
	char rqtp_l_[PADL_(struct l_timespec64 *)];
	struct l_timespec64 *rqtp;
	char rqtp_r_[PADR_(struct l_timespec64 *)];
	char rmtp_l_[PADL_(struct l_timespec64 *)];
	struct l_timespec64 *rmtp;
	char rmtp_r_[PADR_(struct l_timespec64 *)];
};
struct linux_timer_gettime64_args {
	char timerid_l_[PADL_(l_timer_t)];
	l_timer_t timerid;
	char timerid_r_[PADR_(l_timer_t)];
	char setting_l_[PADL_(struct l_itimerspec64 *)];
	struct l_itimerspec64 *setting;
	char setting_r_[PADR_(struct l_itimerspec64 *)];
};
struct linux_timer_settime64_args {
	...
	l_int flags;
	char flags_r_[PADR_(l_int)];
	char new_l_[PADL_(const struct l_itimerspec64 *)];
	const struct l_itimerspec64 *new;
	char new_r_[PADR_(const struct l_itimerspec64 *)];
	char old_l_[PADL_(struct l_itimerspec64 *)];
	struct l_itimerspec64 *old;
	char old_r_[PADR_(struct l_itimerspec64 *)];
};
struct linux_timerfd_gettime64_args {
	...
	char old_value_r_[PADR_(struct l_itimerspec64 *)];
};
struct linux_timerfd_settime64_args {
	...
	l_int flags;
	char flags_r_[PADR_(l_int)];
	char new_value_l_[PADL_(const struct l_itimerspec64 *)];
	const struct l_itimerspec64 *new_value;
	char new_value_r_[PADR_(const struct l_itimerspec64 *)];
	char old_value_l_[PADL_(struct l_itimerspec64 *)];
	struct l_itimerspec64 *old_value;
	char old_value_r_[PADR_(struct l_itimerspec64 *)];
};
struct linux_utimensat_time64_args {
	...
	const char *pathname;
	char pathname_r_[PADR_(const char *)];
	char times64_l_[PADL_(const struct l_timespec64 *)];
	const struct l_timespec64 *times64;
	char times64_r_[PADR_(const struct l_timespec64 *)];
	char flags_l_[PADL_(l_int)];
	l_int flags;
	char flags_r_[PADR_(l_int)];
};
struct linux_pselect6_time64_args {
	...
	l_fd_set *exceptfds;
	char exceptfds_r_[PADR_(l_fd_set *)];
	char tsp_l_[PADL_(struct l_timespec64 *)];
	struct l_timespec64 *tsp;
	char tsp_r_[PADR_(struct l_timespec64 *)];
	char sig_l_[PADL_(l_uintptr_t *)];
	l_uintptr_t *sig;
	char sig_r_[PADR_(l_uintptr_t *)];
};
...
struct linux_recvmmsg_time64_args {
	...
	l_uint flags;
	char flags_r_[PADR_(l_uint)];
	char timeout_l_[PADL_(struct l_timespec64 *)];
	struct l_timespec64 *timeout;
	char timeout_r_[PADR_(struct l_timespec64 *)];
};
...
struct linux_semtimedop_time64_args {
	...
	l_int semid;
	char semid_r_[PADR_(l_int)];
	char tsops_l_[PADL_(struct sembuf *)];
	struct sembuf *tsops;
	char tsops_r_[PADR_(struct sembuf *)];
	char nsops_l_[PADL_(l_size_t)];
	l_size_t nsops;
	char nsops_r_[PADR_(l_size_t)];
	char timeout_l_[PADL_(struct l_timespec64 *)];
	struct l_timespec64 *timeout;
	char timeout_r_[PADR_(struct l_timespec64 *)];
};
...
struct linux_sched_rr_get_interval_time64_args {
	...
	l_pid_t pid;
	char pid_r_[PADR_(l_pid_t)];
	char interval_l_[PADL_(struct l_timespec64 *)];
	struct l_timespec64 *interval;
	char interval_r_[PADR_(struct l_timespec64 *)];
};
...
struct linux_clone3_args {
	char uargs_l_[PADL_(struct l_user_clone_args *)];
	struct l_user_clone_args *uargs;
	char uargs_r_[PADR_(struct l_user_clone_args *)];
	char usize_l_[PADL_(l_size_t)];
	l_size_t usize;
	char usize_r_[PADR_(l_size_t)];
};
struct linux_close_range_args {
	char first_l_[PADL_(l_uint)];
	l_uint first;
	char first_r_[PADR_(l_uint)];
	char last_l_[PADL_(l_uint)];
	l_uint last;
	char last_r_[PADR_(l_uint)];
	char flags_l_[PADL_(l_uint)];
	l_uint flags;
	char flags_r_[PADR_(l_uint)];
};
...
int linux_sched_setscheduler(struct thread *,
    struct linux_sched_setscheduler_args *);
int linux_sched_getscheduler(struct thread *,
    struct linux_sched_getscheduler_args *);
int linux_sched_get_priority_max(struct thread *,
    struct linux_sched_get_priority_max_args *);
int linux_sched_get_priority_min(struct thread *,
    struct linux_sched_get_priority_min_args *);
int linux_sched_rr_get_interval(struct thread *,
    struct linux_sched_rr_get_interval_args *);
...
int linux_sched_setaffinity(struct thread *,
    struct linux_sched_setaffinity_args *);
int linux_sched_getaffinity(struct thread *,
    struct linux_sched_getaffinity_args *);
...
int linux_remap_file_pages(struct thread *,
    struct linux_remap_file_pages_args *);
...
int linux_timer_getoverrun(struct thread *,
    struct linux_timer_getoverrun_args *);
...
int linux_inotify_add_watch(struct thread *,
    struct linux_inotify_add_watch_args *);
int linux_inotify_rm_watch(struct thread *,
    struct linux_inotify_rm_watch_args *);
...
int linux_rt_tgsigqueueinfo(struct thread *,
    struct linux_rt_tgsigqueueinfo_args *);
...
int linux_name_to_handle_at(struct thread *,
    struct linux_name_to_handle_at_args *);
int linux_open_by_handle_at(struct thread *,
    struct linux_open_by_handle_at_args *);
...
int linux_process_vm_readv(struct thread *,
    struct linux_process_vm_readv_args *);
int linux_process_vm_writev(struct thread *,
    struct linux_process_vm_writev_args *);
...
int linux_clock_getres_time64(struct thread *,
    struct linux_clock_getres_time64_args *);
int linux_clock_nanosleep_time64(struct thread *,
    struct linux_clock_nanosleep_time64_args *);
...
int linux_timerfd_gettime64(struct thread *,
    struct linux_timerfd_gettime64_args *);
int linux_timerfd_settime64(struct thread *,
    struct linux_timerfd_settime64_args *);
int linux_utimensat_time64(struct thread *,
    struct linux_utimensat_time64_args *);
...
int linux_io_pgetevents_time64(struct thread *,
    struct linux_io_pgetevents_time64_args *);
int linux_recvmmsg_time64(struct thread *, struct linux_recvmmsg_time64_args *);
int linux_mq_timedsend_time64(struct thread *,
    struct linux_mq_timedsend_time64_args *);
int linux_mq_timedreceive_time64(struct thread *,
    struct linux_mq_timedreceive_time64_args *);
int linux_semtimedop_time64(struct thread *,
    struct linux_semtimedop_time64_args *);
int linux_rt_sigtimedwait_time64(struct thread *,
    struct linux_rt_sigtimedwait_time64_args *);
int linux_sys_futex_time64(struct thread *,
    struct linux_sys_futex_time64_args *);
int linux_sched_rr_get_interval_time64(struct thread *,
    struct linux_sched_rr_get_interval_time64_args *);
int linux_pidfd_send_signal(struct thread *,
    struct linux_pidfd_send_signal_args *);
...
int linux_io_uring_register(struct thread *,
    struct linux_io_uring_register_args *);
...
int linux_landlock_create_ruleset(struct thread *,
    struct linux_landlock_create_ruleset_args *);
int linux_landlock_add_rule(struct thread *,
    struct linux_landlock_add_rule_args *);
int linux_landlock_restrict_self(struct thread *,
    struct linux_landlock_restrict_self_args *);
int linux_memfd_secret(struct thread *, struct linux_memfd_secret_args *);
int linux_process_mrelease(struct thread *,
    struct linux_process_mrelease_args *);
int linux_futex_waitv(struct thread *, struct linux_futex_waitv_args *);
int linux_set_mempolicy_home_node(struct thread *,
    struct linux_set_mempolicy_home_node_args *);
...
#define LINUX_SYS_AUE_linux_sched_rr_get_interval_time64 \
