...
typedef int (
    *lookupfunc_t)(struct ipf_main_softc_s *, void *, int, void *, u_int);
...
#define IP6_EQ(a, b)                                                       \
	((I63(a) == I63(b)) && (I62(a) == I62(b)) && (I61(a) == I61(b)) && \
	    (I60(a) == I60(b)))
#define IP6_NEQ(a, b)                                                      \
	((I63(a) != I63(b)) || (I62(a) != I62(b)) || (I61(a) != I61(b)) || \
	    (I60(a) != I60(b)))
...
#define IP6_ISONES(a)                                        \
	((I63(a) == 0xffffffff) && (I62(a) == 0xffffffff) && \
	    (I61(a) == 0xffffffff) && (I60(a) == 0xffffffff))
#define IP6_GT(a, b)                                        \
	(ntohl(HI60(a)) > ntohl(HI60(b)) ||                 \
	    (HI60(a) == HI60(b) &&                          \
...
#define IP6_AND(a, b, d)                             \
	do {                                         \
		i6addr_t *_s1 = (i6addr_t *)(a);     \
...
#define IP6_MASKEQ(a, m, b)                                                \
	(((I60(a) & I60(m)) == I60(b)) && ((I61(a) & I61(m)) == I61(b)) && \
	    ((I62(a) & I62(m)) == I62(b)) && ((I63(a) & I63(m)) == I63(b)))
...
typedef enum fr_dtypes_e { FRD_NORMAL = 0, FRD_DSTLIST } fr_dtypes_t;
/*
...
extern int ipfioctl(ipf_main_softc_t *, int, ioctlcmd_t, caddr_t, int);
...
#endif
extern int frrequest(ipf_main_softc_t *, int, ioctlcmd_t, caddr_t, int, int);
...
extern int ipf_ioctlswitch(ipf_main_softc_t *, int, void *, ioctlcmd_t, int,
    int, void *);
extern int ipf_ipf_ioctl(ipf_main_softc_t *, caddr_t, ioctlcmd_t, int, int,
    void *);
extern int ipf_ipftune(ipf_main_softc_t *, ioctlcmd_t, void *);
extern int ipf_matcharray_load(ipf_main_softc_t *, caddr_t, ipfobj_t *, int **);
...
extern int ipf_resolvedest(ipf_main_softc_t *, char *, struct frdest *, int);
...
extern ipftq_t *ipf_addtimeoutqueue(ipf_main_softc_t *, ipftq_t **, u_int);
...
extern void ipf_movequeue(u_long, ipftqent_t *, ipftq_t *, ipftq_t *);
extern void ipf_queueappend(u_long, ipftqent_t *, ipftq_t *, void *);
extern void ipf_queueback(u_long, ipftqent_t *);
extern int ipf_queueflush(ipf_main_softc_t *, ipftq_delete_fn_t, ipftq_t *,
    ipftq_t *, u_int *, int, int);
extern void ipf_queuefront(ipftqent_t *);
extern int ipf_settimeout_tcp(ipftuneable_t *, ipftuneval_t *, ipftq_t *);
extern int ipf_checkv4sum(fr_info_t *);
extern int ipf_checkl4sum(fr_info_t *);
extern int ipf_ifpfillv4addr(int, struct sockaddr_in *, struct sockaddr_in *,
    struct in_addr *, struct in_addr *);
extern int ipf_coalesce(fr_info_t *);
#ifdef USE_INET6
extern int ipf_checkv6sum(fr_info_t *);
extern int ipf_ifpfillv6addr(int, struct sockaddr_in6 *, struct sockaddr_in6 *,
    i6addr_t *, i6addr_t *);
#endif
...
extern int ipf_tune_array_unlink(ipf_main_softc_t *, ipftuneable_t *);
extern ipftuneable_t *ipf_tune_array_copy(void *, size_t, ipftuneable_t *);

extern int ipf_pr_pullup(fr_info_t *, int);

extern int ipf_flush(ipf_main_softc_t *, minor_t, int);
extern frgroup_t *ipf_group_add(ipf_main_softc_t *, char *, void *, u_32_t,
    minor_t, int);
extern void ipf_group_del(ipf_main_softc_t *, frgroup_t *, frentry_t *);
extern int ipf_derefrule(ipf_main_softc_t *, frentry_t **);
extern frgroup_t *ipf_findgroup(ipf_main_softc_t *, char *, minor_t, int,
    frgroup_t ***);
...
extern int ipf_log_items(ipf_main_softc_t *, int, fr_info_t *, void **,
    size_t *, int *, int);
...
extern int ipf_deliverlocal(ipf_main_softc_t *, int, void *, i6addr_t *);
...
extern int ipf_ifpaddr(ipf_main_softc_t *, int, int, void *, i6addr_t *,
    i6addr_t *);
...
extern int ipf_matchicmpqueryreply(int, icmpinfo_t *, struct icmp *, int);
extern u_32_t ipf_newisn(fr_info_t *);
extern u_int ipf_pcksum(fr_info_t *, int, u_int);
#ifdef USE_INET6
extern u_int ipf_pcksum6(struct mbuf *, ip6_t *, u_int32_t, u_int32_t);
#endif
...
extern int ipf_getnextrule(ipf_main_softc_t *, ipftoken_t *, void *);
...
extern int ipf_genericiter(ipf_main_softc_t *, void *, int, void *);
...
extern int ipf_ht_node_add(ipf_main_softc_t *, host_track_t *, int, i6addr_t *);
