...
typedef struct aproxy {
	...
	int (*apr_new)(void *, fr_info_t *, ap_session_t *, struct nat *);
	void (*apr_del)(ipf_main_softc_t *, ap_session_t *);
	int (*apr_inpkt)(void *, fr_info_t *, ap_session_t *, struct nat *);
	int (*apr_outpkt)(void *, fr_info_t *, ap_session_t *, struct nat *);
...
#define RPCB_BUF_EQ(r, p, l) (RPCB_BUF_END((r)) == ((char *)(p) + (l)))
...
extern int ipf_proxy_ioctl(ipf_main_softc_t *, caddr_t, ioctlcmd_t, int,
    void *);
