...
#define IPFR_CMPSZ (offsetof(ipfr_t, ipfr_pass) - offsetof(ipfr_t, ipfr_ifp))
...
extern int ipf_frag_natnew(ipf_main_softc_t *, fr_info_t *, u_32_t,
    struct nat *);
...
extern int ipf_frag_pkt_next(ipf_main_softc_t *, ipftoken_t *, ipfgeniter_t *);
extern void ipf_frag_nat_deref(ipf_main_softc_t *, void *);
extern int ipf_frag_nat_next(ipf_main_softc_t *, ipftoken_t *, ipfgeniter_t *);
