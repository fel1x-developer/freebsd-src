...
typedef struct ipf_lookup {
	...
	int (*ipfl_addr_find)(ipf_main_softc_t *, void *, int, void *, u_int);
	size_t (*ipfl_flush)(ipf_main_softc_t *, void *, iplookupflush_t *);
	int (*ipfl_iter_deref)(ipf_main_softc_t *, void *, int, int, void *);
	int (*ipfl_iter_next)(ipf_main_softc_t *, void *, ipftoken_t *,
	    ipflookupiter_t *);
	int (*ipfl_node_add)(ipf_main_softc_t *, void *, iplookupop_t *, int);
	int (*ipfl_node_del)(ipf_main_softc_t *, void *, iplookupop_t *, int);
	int (*ipfl_stats_get)(ipf_main_softc_t *, void *, iplookupop_t *);
	int (*ipfl_table_add)(ipf_main_softc_t *, void *, iplookupop_t *);
	int (*ipfl_table_del)(ipf_main_softc_t *, void *, iplookupop_t *);
	int (*ipfl_table_deref)(ipf_main_softc_t *, void *, void *);
	void *(*ipfl_table_find)(void *, int, char *);
	void *(*ipfl_select_add_ref)(void *, int, char *);
	int (*ipfl_select_node)(fr_info_t *, void *, u_32_t *, frdest_t *);
	void (*ipfl_expire)(ipf_main_softc_t *, void *);
	void (*ipfl_sync)(ipf_main_softc_t *, void *);
} ipf_lookup_t;

extern int ipf_lookup_init(void);
extern int ipf_lookup_ioctl(ipf_main_softc_t *, caddr_t, ioctlcmd_t, int, int,
    void *);
