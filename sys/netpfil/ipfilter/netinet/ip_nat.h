...
#define IPN_USERFLAGS                                                    \
	(IPN_TCPUDP | IPN_AUTOPORTMAP | IPN_SIPRANGE | IPN_SPLIT |       \
...
#define NAT_HASH_FN6(_k, _l, _m)                                         \
	((((u_32_t *)(_k))[3] + (((u_32_t *)(_k))[3] >> 12) +            \
	     (((u_32_t *)(_k))[2]) + (((u_32_t *)(_k))[2] >> 12) +       \
	     (((u_32_t *)(_k))[1]) + (((u_32_t *)(_k))[1] >> 12) +       \
	     (((u_32_t *)(_k))[0]) + (((u_32_t *)(_k))[0] >> 12) + _l) % \
	    (_m))

#define LONG_SUM(_i) (((_i) & 0xffff) + ((_i) >> 16))
#define LONG_SUM6(_i)                              \
	(LONG_SUM(ntohl(((u_32_t *)(_i))[0])) +    \
...
extern int ipf_nat_hashtab_add(ipf_main_softc_t *, ipf_nat_softc_t *, nat_t *);
extern void ipf_nat_hostmapdel(ipf_main_softc_t *, hostmap_t **);
extern int ipf_nat_hostmap_rehash(ipf_main_softc_t *, ipftuneable_t *,
    ipftuneval_t *);
...
extern nat_t *ipf_nat_inlookup(fr_info_t *, u_int, u_int, struct in_addr,
    struct in_addr);
extern int ipf_nat_in(fr_info_t *, nat_t *, int, u_32_t);
extern int ipf_nat_insert(ipf_main_softc_t *, ipf_nat_softc_t *, nat_t *);
extern int ipf_nat_ioctl(ipf_main_softc_t *, caddr_t, ioctlcmd_t, int, int,
    void *);
extern void ipf_nat_log(ipf_main_softc_t *, ipf_nat_softc_t *, struct nat *,
    u_int);
extern nat_t *ipf_nat_lookupredir(natlookup_t *);
extern nat_t *ipf_nat_maplookup(void *, u_int, struct in_addr, struct in_addr);
extern nat_t *ipf_nat_add(fr_info_t *, ipnat_t *, nat_t **, u_int, int);
extern int ipf_nat_out(fr_info_t *, nat_t *, int, u_32_t);
extern nat_t *ipf_nat_outlookup(fr_info_t *, u_int, u_int, struct in_addr,
    struct in_addr);
extern u_short *ipf_nat_proto(fr_info_t *, nat_t *, u_int);
extern void ipf_nat_rule_deref(ipf_main_softc_t *, ipnat_t **);
extern void ipf_nat_setqueue(ipf_main_softc_t *, ipf_nat_softc_t *, nat_t *);
...
extern int ipf_nat_rehash(ipf_main_softc_t *, ipftuneable_t *, ipftuneval_t *);
extern int ipf_nat_rehash_rules(ipf_main_softc_t *, ipftuneable_t *,
    ipftuneval_t *);
extern int ipf_nat_settimeout(struct ipf_main_softc_s *, ipftuneable_t *,
    ipftuneval_t *);
...
#ifdef USE_INET6
extern nat_t *ipf_nat6_add(fr_info_t *, ipnat_t *, nat_t **, u_int, int);
...
extern nat_t *ipf_nat6_inlookup(fr_info_t *, u_int, u_int, struct in6_addr *,
    struct in6_addr *);
...
extern nat_t *ipf_nat6_outlookup(fr_info_t *, u_int, u_int, struct in6_addr *,
    struct in6_addr *);
extern int ipf_nat6_newrewrite(fr_info_t *, nat_t *, natinfo_t *);
extern int ipf_nat6_newdivert(fr_info_t *, nat_t *, natinfo_t *);
extern int ipf_nat6_ruleaddrinit(ipf_main_softc_t *, ipf_nat_softc_t *,
    ipnat_t *);
