...
#define ahc_scsiid_ultra2_print(regvalue, cur_col, wrap)                      \
	ahc_print_register(NULL, 0, "SCSIID_ULTRA2", 0x0f, regvalue, cur_col, \
	    wrap)
#endif
...
#define ahc_busy_targets_print(regvalue, cur_col, wrap)                      \
	ahc_print_register(NULL, 0, "BUSY_TARGETS", 0x20, regvalue, cur_col, \
	    wrap)
#endif
...
#define ahc_cmdsize_table_tail_print(regvalue, cur_col, wrap)             \
	ahc_print_register(NULL, 0, "CMDSIZE_TABLE_TAIL", 0x34, regvalue, \
	    cur_col, wrap)
#endif
...
#define ahc_mwi_residual_print(regvalue, cur_col, wrap)                      \
	ahc_print_register(NULL, 0, "MWI_RESIDUAL", 0x38, regvalue, cur_col, \
	    wrap)
#endif
...
#define ahc_next_queued_scb_print(regvalue, cur_col, wrap)             \
	ahc_print_register(NULL, 0, "NEXT_QUEUED_SCB", 0x39, regvalue, \
	    cur_col, wrap)
#endif
...
#define ahc_saved_scsiid_print(regvalue, cur_col, wrap)                      \
	ahc_print_register(NULL, 0, "SAVED_SCSIID", 0x3d, regvalue, cur_col, \
	    wrap)
#endif
...
#define ahc_waiting_scbh_print(regvalue, cur_col, wrap)                      \
	ahc_print_register(NULL, 0, "WAITING_SCBH", 0x40, regvalue, cur_col, \
	    wrap)
#endif
...
#define ahc_disconnected_scbh_print(regvalue, cur_col, wrap)             \
	ahc_print_register(NULL, 0, "DISCONNECTED_SCBH", 0x41, regvalue, \
	    cur_col, wrap)
#endif
...
#define ahc_complete_scbh_print(regvalue, cur_col, wrap)                      \
	ahc_print_register(NULL, 0, "COMPLETE_SCBH", 0x43, regvalue, cur_col, \
	    wrap)
#endif
...
#define ahc_shared_data_addr_print(regvalue, cur_col, wrap)             \
	ahc_print_register(NULL, 0, "SHARED_DATA_ADDR", 0x48, regvalue, \
	    cur_col, wrap)
#endif
...
#define ahc_kernel_qinpos_print(regvalue, cur_col, wrap)                      \
	ahc_print_register(NULL, 0, "KERNEL_QINPOS", 0x4c, regvalue, cur_col, \
	    wrap)
#endif
...
#define ahc_kernel_tqinpos_print(regvalue, cur_col, wrap)                      \
	ahc_print_register(NULL, 0, "KERNEL_TQINPOS", 0x4f, regvalue, cur_col, \
	    wrap)
#endif
...
#define ahc_scsiseq_template_print(regvalue, cur_col, wrap)             \
	ahc_print_register(NULL, 0, "SCSISEQ_TEMPLATE", 0x54, regvalue, \
	    cur_col, wrap)
#endif
...
#define ahc_ha_274_biosglobal_print(regvalue, cur_col, wrap)             \
	ahc_print_register(NULL, 0, "HA_274_BIOSGLOBAL", 0x56, regvalue, \
	    cur_col, wrap)
#endif
...
#define ahc_ha_274_biosctrl_print(regvalue, cur_col, wrap)             \
	ahc_print_register(NULL, 0, "HA_274_BIOSCTRL", 0x5f, regvalue, \
	    cur_col, wrap)
#endif
...
#define ahc_targ_offset_print(regvalue, cur_col, wrap)                      \
	ahc_print_register(NULL, 0, "TARG_OFFSET", 0x70, regvalue, cur_col, \
	    wrap)
#endif
...
#define ahc_dspcistatus_print(regvalue, cur_col, wrap)                      \
	ahc_print_register(NULL, 0, "DSPCISTATUS", 0x86, regvalue, cur_col, \
	    wrap)
#endif
...
#define ahc_crccontrol1_print(regvalue, cur_col, wrap)                      \
	ahc_print_register(NULL, 0, "CRCCONTROL1", 0x9d, regvalue, cur_col, \
	    wrap)
#endif
...
#define ahc_scb_cdb_ptr_print(regvalue, cur_col, wrap)                      \
	ahc_print_register(NULL, 0, "SCB_CDB_PTR", 0xa0, regvalue, cur_col, \
	    wrap)
#endif
...
#define ahc_scb_residual_sgptr_print(regvalue, cur_col, wrap)             \
	ahc_print_register(NULL, 0, "SCB_RESIDUAL_SGPTR", 0xa4, regvalue, \
	    cur_col, wrap)
#endif
...
#define ahc_scb_scsi_status_print(regvalue, cur_col, wrap)             \
	ahc_print_register(NULL, 0, "SCB_SCSI_STATUS", 0xa8, regvalue, \
	    cur_col, wrap)
#endif
...
#define ahc_scb_target_phases_print(regvalue, cur_col, wrap)             \
	ahc_print_register(NULL, 0, "SCB_TARGET_PHASES", 0xa9, regvalue, \
	    cur_col, wrap)
#endif
...
#define ahc_scb_target_data_dir_print(regvalue, cur_col, wrap)             \
	ahc_print_register(NULL, 0, "SCB_TARGET_DATA_DIR", 0xaa, regvalue, \
	    cur_col, wrap)
#endif
...
#define ahc_scb_target_itag_print(regvalue, cur_col, wrap)             \
	ahc_print_register(NULL, 0, "SCB_TARGET_ITAG", 0xab, regvalue, \
	    cur_col, wrap)
#endif
...
#define ahc_scb_dataptr_print(regvalue, cur_col, wrap)                      \
	ahc_print_register(NULL, 0, "SCB_DATAPTR", 0xac, regvalue, cur_col, \
	    wrap)
#endif
...
#define ahc_scb_datacnt_print(regvalue, cur_col, wrap)                      \
	ahc_print_register(NULL, 0, "SCB_DATACNT", 0xb0, regvalue, cur_col, \
	    wrap)
#endif
...
#define ahc_scb_control_print(regvalue, cur_col, wrap)                      \
	ahc_print_register(NULL, 0, "SCB_CONTROL", 0xb8, regvalue, cur_col, \
	    wrap)
#endif
...
#define ahc_scb_cdb_len_print(regvalue, cur_col, wrap)                      \
	ahc_print_register(NULL, 0, "SCB_CDB_LEN", 0xbc, regvalue, cur_col, \
	    wrap)
#endif
...
#define ahc_scb_scsirate_print(regvalue, cur_col, wrap)                      \
	ahc_print_register(NULL, 0, "SCB_SCSIRATE", 0xbd, regvalue, cur_col, \
	    wrap)
#endif
...
#define ahc_scb_scsioffset_print(regvalue, cur_col, wrap)                      \
	ahc_print_register(NULL, 0, "SCB_SCSIOFFSET", 0xbe, regvalue, cur_col, \
	    wrap)
#endif
...
#define ahc_scb_64_spare_print(regvalue, cur_col, wrap)                      \
	ahc_print_register(NULL, 0, "SCB_64_SPARE", 0xc0, regvalue, cur_col, \
	    wrap)
#endif
...
#define ahc_seectl_2840_print(regvalue, cur_col, wrap)                      \
	ahc_print_register(NULL, 0, "SEECTL_2840", 0xc0, regvalue, cur_col, \
	    wrap)
#endif
...
#define ahc_status_2840_print(regvalue, cur_col, wrap)                      \
	ahc_print_register(NULL, 0, "STATUS_2840", 0xc1, regvalue, cur_col, \
	    wrap)
#endif
...
#define ahc_qoff_ctlsta_print(regvalue, cur_col, wrap)                      \
	ahc_print_register(NULL, 0, "QOFF_CTLSTA", 0xfa, regvalue, cur_col, \
	    wrap)
#endif
...
#define ahc_sg_cache_shadow_print(regvalue, cur_col, wrap)             \
	ahc_print_register(NULL, 0, "SG_CACHE_SHADOW", 0xfc, regvalue, \
	    cur_col, wrap)
#endif
...
#define ahc_sg_cache_pre_print(regvalue, cur_col, wrap)                      \
	ahc_print_register(NULL, 0, "SG_CACHE_PRE", 0xfc, regvalue, cur_col, \
	    wrap)
#endif
