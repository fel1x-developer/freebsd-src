...
#define BUG_ON(cond) \
	KASSERT(!(cond), ("BUG ON: " #cond " -> 0x%jx", (uintmax_t)(cond)))
...
#define drm_get_device_from_kdev(_kdev) \
	(((struct drm_minor *)(_kdev)->si_drv1)->dev)
...
enum __drm_capabilities { CAP_SYS_ADMIN };
...
#define timespec_to_jiffies(x) \
	(((x)->tv_sec * 1000000 + (x)->tv_nsec) * hz / 1000000)
#define time_after(a, b) ((long)(b) - (long)(a) < 0)
#define time_after_eq(a, b) ((long)(b) - (long)(a) <= 0)
#define round_jiffies(j)                                   \
	((unsigned long)(((j) + drm_linux_timer_hz_mask) & \
