...
#define WRITE_CSR_INT_FLAG(csr_base_addr, bank, value) \
	ADF_CSR_WR(csr_base_addr,                      \
	    (ADF_RING_BUNDLE_SIZE * (bank)) + ADF_RING_CSR_INT_FLAG, value)
...
#define READ_CSR_AE2FUNCTION_MAP_A(pmisc_bar_addr, index) \
	ADF_CSR_RD(pmisc_bar_addr,                        \
	    AE2FUNCTION_MAP_A_OFFSET + AE2FUNCTION_MAP_REG_SIZE * (index))
...
#define READ_CSR_AE2FUNCTION_MAP_B(pmisc_bar_addr, index) \
	ADF_CSR_RD(pmisc_bar_addr,                        \
	    AE2FUNCTION_MAP_B_OFFSET + AE2FUNCTION_MAP_REG_SIZE * (index))
