...
LacSymQat_ConstantsInitLookupTables(CpaInstanceHandle instanceHandle)
{
	...
	memset(icp_qat_hw_cipher_lookup_tbl, 0,
	    sizeof(icp_qat_hw_cipher_lookup_tbl));
	memset(icp_qat_hw_auth_lookup_tbl, 0,
	...
	memcpy(pConstantsLookupTables->auth_offset, icp_qat_hw_auth_lookup_tbl,
 ...
 *****************************************************************************/
void
LacSymQat_ConstantsGetAuthOffset(CpaInstanceHandle instanceHandle, uint8_t algo,
    uint8_t mode, uint8_t nested, uint8_t *poffset)
{
	sal_service_t *pService = (sal_service_t *)instanceHandle;
	lac_sym_qat_constants_t *pConstantsLookupTables;
