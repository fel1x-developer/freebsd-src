 ...
 *
 *  + ===== + ----- + --- +-----+-------+ --- + ---------+ --- + ---- + --- +
 * --- + |  Bit  | 31-20 |  19 |  18 |   17  | 16  |  15 - 7  |  6  |  5-2 |  1
 * |  0  |
 *  + ===== + ----- + --- +-----+-------+ --- + ---------+ --- | ---- + --- +
 * --- + | Flags | Resvd | CRC | CNV | CNVNR | CNV |Resvd Bits|BFin |Resvd | EOP
 * | SOP | |       | =0    | Mode| DFX |       |     | =0       |     | =0   |
 * |     | |       |       |     |     |       |     |          |     |      |
 * |     |
 *  + ===== + ----- + --- +-----+-------+ --- + ---------+ --- | ---- + --- +
...
#define ICP_QAT_FW_COMP_PART_DECOMP_GET(flags)                   \
	QAT_FIELD_GET(flags, ICP_QAT_FW_COMP_PART_DECOMP_BITPOS, \
...
#define ICP_QAT_FW_COMP_PART_DECOMP_SET(flags, val)                   \
	QAT_FIELD_SET(flags, val, ICP_QAT_FW_COMP_PART_DECOMP_BITPOS, \
	    ICP_QAT_FW_COMP_PART_DECOMP_MASK)
...
#define ICP_QAT_FW_COMP_ZEROPAD_GET(flags)                   \
	QAT_FIELD_GET(flags, ICP_QAT_FW_COMP_ZEROPAD_BITPOS, \
...
#define ICP_QAT_FW_COMP_ZEROPAD_SET(flags, val)                   \
	QAT_FIELD_SET(flags, val, ICP_QAT_FW_COMP_ZEROPAD_BITPOS, \
	    ICP_QAT_FW_COMP_ZEROPAD_MASK)
...
#define ICP_QAT_FW_COMP_RAM_FLAGS_BUILD(bank_i_enable, bank_h_enable,          \
    bank_g_enable, bank_f_enable, bank_e_enable, bank_d_enable, bank_c_enable, \
