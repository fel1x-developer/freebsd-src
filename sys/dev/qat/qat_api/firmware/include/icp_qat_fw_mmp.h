...
typedef struct icp_qat_fw_mmp_ecdsa_sign_rs_p384_input_s {
	uint64_t k; /**< k  = random value, &gt; 0 and &lt; n (order of G for
		       P384) (6 qwords)*/
	uint64_t e; /**<  (6 qwords)*/
	uint64_t d; /**<  (6 qwords)*/
...
typedef struct icp_qat_fw_mmp_rsa_kp2_512_input_s {
	uint64_t p; /**< RSA parameter, prime, &nbsp;2^255 &lt; p &lt; 2^256 (4
		       qwords)*/
	uint64_t q; /**< RSA parameter, prime, &nbsp;2^255 &lt; q &lt; 2^256 (4
		       qwords)*/
	uint64_t e; /**< RSA public key, must be odd, &ge; 3 and &le; (p*q)-1,
		       &nbsp;with GCD(e, p-1, q-1) = 1 (8 qwords)*/
...
typedef struct icp_qat_fw_mmp_rsa_kp2_1024_input_s {
	uint64_t p; /**< RSA parameter, prime, &nbsp;2^511 &lt; p &lt; 2^512 (8
		       qwords)*/
	uint64_t q; /**< RSA parameter, prime, &nbsp;2^511 &lt; q &lt; 2^512 (8
		       qwords)*/
	uint64_t e; /**< RSA public key, must be odd, &ge; 3 and &le; (p*q)-1,
		       &nbsp;with GCD(e, p-1, q-1) = 1 (16 qwords)*/
...
typedef struct icp_qat_fw_mmp_rsa_dp2_8192_input_s {
	...
	uint64_t p;  /**< RSA parameter, prime, &nbsp;2^4095 &lt; p &lt; 2^4096
			(64  qwords)*/
	uint64_t q;  /**< RSA parameter, prime, &nbsp;2^4095 &lt; q &lt; 2^4096
			(64  qwords)*/
...
typedef struct icp_qat_fw_maths_modinv_odd_l8192_input_s {
	...
	uint64_t b; /**< odd modulus &gt; 0 and &lt; 2^8192, coprime to a (128
		       qwords)*/
...
typedef struct icp_qat_fw_maths_modinv_even_l8192_input_s {
	...
	uint64_t b; /**< even modulus   &gt; 0 and &lt; 2^8192, coprime with a
		       (128 qwords)*/
...
typedef struct icp_qat_fw_mmp_ecdsa_verify_gf2_l256_input_s {
	uint64_t in; /**< concatenated curve parameter (e,s,r,n,G,Q,a,b,q)  (44
			qwords)*/
...
typedef struct icp_qat_fw_mmp_ecdsa_verify_gf2_l512_input_s {
	uint64_t in; /**< concatenated curve parameters (e, s, r, n, xG, yG, xQ,
			yQ, a, b, q)  (88 qwords)*/
...
typedef struct icp_qat_fw_mmp_ecdsa_sign_rs_gf2_571_input_s {
	uint64_t in; /**< concatenated input parameters (x(G), y(G), n, q, a, b,
			k, e, d)  (81 qwords)*/
...
typedef struct icp_qat_fw_maths_point_verify_gf2_l256_input_s {
	...
	uint64_t a; /**< a equation coefficient of curve, degree(a) &lt; 256 (4
		       qwords)*/
	uint64_t b; /**< b equation coefficient of curve, degree(b) &lt; 256 (4
		       qwords)*/
...
typedef struct icp_qat_fw_mmp_dh_g2_8192_output_s {
	uint64_t r; /**< modular exponentiation result  &ge; 0 and &lt; m (128
		       qwords)*/
...
typedef struct icp_qat_fw_maths_modinv_odd_l128_output_s {
	uint64_t c; /**< modular multiplicative inverse of a, &gt; 0 and &lt; b
		       (2 qwords)*/
...
typedef struct icp_qat_fw_point_multiplication_c25519_output_s {
	uint64_t xr; /**< xR = Montgomery affine coordinate X of point [k]P  (4
			qwords)*/
...
typedef struct icp_qat_fw_generator_multiplication_c25519_output_s {
	uint64_t xr; /**< xR = Montgomery affine coordinate X of point [k]G  (4
			qwords)*/
...
typedef struct icp_qat_fw_point_multiplication_c448_output_s {
	uint64_t xr; /**< xR = Montgomery affine coordinate X of point [k]P  (8
			qwords)*/
...
typedef struct icp_qat_fw_generator_multiplication_c448_output_s {
	uint64_t xr; /**< xR = Montgomery affine coordinate X of point [k]G  (8
			qwords)*/
