...
#define emajor(x)                                                  \
	(major_t)(((unsigned int)(x) >> O_BITSMINOR) > O_MAXMAJ) ? \
	    NODEV :                                                \
	    (((unsigned int)(x) >> O_BITSMINOR) & O_MAXMAJ)
 ...
 */
#define getemajor(x)                                         \
	(major_t)((((dev_t)(x) >> L_BITSMINOR) > L_MAXMAJ) ? \
		NODEV :                                      \
...
#define DEVCMPL(x)                                         \
	(dev32_t)((((x) >> L_BITSMINOR) > L_MAXMAJ32 ||    \
		...
		NODEV32 :                                  \
		((((x) >> L_BITSMINOR) << L_BITSMINOR32) | \
		    ((x) & L_MAXMIN32)))

#define DEVEXPL(x)                                                          \
	(((x) == NODEV32) ? NODEV :                                         \
			    makedevice(((x) >> L_BITSMINOR32) & L_MAXMAJ32, \
				(x) & L_MAXMIN32))
...
#define cmpdev(x)                                                              \
	(o_dev_t)(                                                             \
	    (((x) >> L_BITSMINOR) > O_MAXMAJ || ((x) & L_MAXMIN) > O_MAXMIN) ? \
		NODEV :                                                        \
...
#define DECL_BITFIELD2(_a, _b) uint8_t _a, _b
#define DECL_BITFIELD3(_a, _b, _c) uint8_t _a, _b, _c
#define DECL_BITFIELD4(_a, _b, _c, _d) uint8_t _a, _b, _c, _d
#define DECL_BITFIELD5(_a, _b, _c, _d, _e) uint8_t _a, _b, _c, _d, _e
#define DECL_BITFIELD6(_a, _b, _c, _d, _e, _f) uint8_t _a, _b, _c, _d, _e, _f
...
#define DECL_BITFIELD2(_a, _b) uint8_t _b, _a
#define DECL_BITFIELD3(_a, _b, _c) uint8_t _c, _b, _a
#define DECL_BITFIELD4(_a, _b, _c, _d) uint8_t _d, _c, _b, _a
#define DECL_BITFIELD5(_a, _b, _c, _d, _e) uint8_t _e, _d, _c, _b, _a
#define DECL_BITFIELD6(_a, _b, _c, _d, _e, _f) uint8_t _f, _e, _d, _c, _b, _a
#define DECL_BITFIELD7(_a, _b, _c, _d, _e, _f, _g) \
