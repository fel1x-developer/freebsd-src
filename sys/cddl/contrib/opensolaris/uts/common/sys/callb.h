...
#define CALLB_CPR_INIT(cp, lockp, func, name)                                 \
	{                                                                     \
		...
		(cp)->cc_lockp = lockp;                                       \
		(cp)->cc_id = callb_add(func, (void *)(cp), CB_CL_CPR_DAEMON, \
		    name);                                                    \
...
#define CALLB_CPR_INIT_SAFE(t, name)                                         \
	{                                                                    \
		(void)callb_add_thread(callb_generic_cpr_safe,               \
		    (void *)&callb_cprinfo_safe, CB_CL_CPR_DAEMON, name, t); \
	}
/*
...
extern callb_id_t callb_add_thread(boolean_t (*)(void *, int), void *, int,
    char *, kthread_id_t);
