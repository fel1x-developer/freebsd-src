...
int rijndael_blockEncrypt(cipherInstance *, keyInstance *, const uint8_t *, int,
    uint8_t *);
int rijndael_padEncrypt(cipherInstance *, keyInstance *, const uint8_t *, int,
    uint8_t *);

int rijndael_blockDecrypt(cipherInstance *, keyInstance *, const uint8_t *, int,
    uint8_t *);
int rijndael_padDecrypt(cipherInstance *, keyInstance *, const uint8_t *, int,
    uint8_t *);
