...
void Skein_Show_Block(uint_t bits, const Skein_Ctxt_Hdr_t *h, const u64b_t *X,
    ...
    const u64b_t *tsPtr);
void Skein_Show_Round(uint_t bits, const Skein_Ctxt_Hdr_t *h, size_t r,
    const u64b_t *X);
void Skein_Show_R_Ptr(uint_t bits, const Skein_Ctxt_Hdr_t *h, size_t r,
    const u64b_t *X_ptr[]);
void Skein_Show_Final(uint_t bits, const Skein_Ctxt_Hdr_t *h, size_t cnt,
    const u08b_t *outPtr);
void Skein_Show_Key(uint_t bits, const Skein_Ctxt_Hdr_t *h, const u08b_t *key,
    size_t keyBytes);
...
#define SKEIN_DEBUG_INJECT \
	(1u << 8) /* show state after key injection & feedforward points */
...
#define SKEIN_DEBUG_THREEFISH \
	(1u << 12)		       /* use Threefish name instead of Skein */
