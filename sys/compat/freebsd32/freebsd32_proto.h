...
struct freebsd32_sendmsg_args {
	...
	int s;
	char s_r_[PADR_(int)];
	char msg_l_[PADL_(const struct msghdr32 *)];
	const struct msghdr32 *msg;
	char msg_r_[PADR_(const struct msghdr32 *)];
	char flags_l_[PADL_(int)];
	int flags;
	char flags_r_[PADR_(int)];
};
struct freebsd32_sigaltstack_args {
	char ss_l_[PADL_(const struct sigaltstack32 *)];
	const struct sigaltstack32 *ss;
	char ss_r_[PADR_(const struct sigaltstack32 *)];
...
struct freebsd32_setitimer_args {
	...
	char itv_l_[PADL_(const struct itimerval32 *)];
	const struct itimerval32 *itv;
	char itv_r_[PADR_(const struct itimerval32 *)];
...
struct freebsd32_fcntl_args {
	...
	char arg_l_[PADL_(int32_t)];
	int32_t arg;
	char arg_r_[PADR_(int32_t)];
};
...
struct freebsd32_settimeofday_args {
	char tv_l_[PADL_(const struct timeval32 *)];
	const struct timeval32 *tv;
	char tv_r_[PADR_(const struct timeval32 *)];
	char tzp_l_[PADL_(const struct timezone *)];
	const struct timezone *tzp;
	char tzp_r_[PADR_(const struct timezone *)];
};
struct freebsd32_utimes_args {
	char path_l_[PADL_(const char *)];
	const char *path;
	char path_r_[PADR_(const char *)];
	char tptr_l_[PADL_(const struct timeval32 *)];
	const struct timeval32 *tptr;
	char tptr_r_[PADR_(const struct timeval32 *)];
};
struct freebsd32_adjtime_args {
	char delta_l_[PADL_(const struct timeval32 *)];
	const struct timeval32 *delta;
	char delta_r_[PADR_(const struct timeval32 *)];
...
struct freebsd32_msgrcv_args {
	...
	size_t msgsz;
	char msgsz_r_[PADR_(size_t)];
	char msgtyp_l_[PADL_(int32_t)];
	int32_t msgtyp;
	char msgtyp_r_[PADR_(int32_t)];
	char msgflg_l_[PADL_(int)];
	int msgflg;
	char msgflg_r_[PADR_(int)];
};
...
struct freebsd32_ffclock_setestimate_args {
	char cest_l_[PADL_(struct ffclock_estimate32 *)];
	struct ffclock_estimate32 *cest;
	char cest_r_[PADR_(struct ffclock_estimate32 *)];
};
...
struct freebsd32_lio_listio_args {
	...
	char acb_list_l_[PADL_(uint32_t *)];
	uint32_t *acb_list;
	char acb_list_r_[PADR_(uint32_t *)];
...
struct freebsd32_preadv_args {
	...
	char _pad_l_[PADL_(int)];
	int _pad;
	char _pad_r_[PADR_(int)];
#endif
...
struct freebsd32_kldstat_args {
	...
	char stat_l_[PADL_(struct kld_file_stat32 *)];
	struct kld_file_stat32 *stat;
	char stat_r_[PADR_(struct kld_file_stat32 *)];
};
...
struct freebsd32_aio_suspend_args {
	char aiocbp_l_[PADL_(uint32_t *)];
	uint32_t *aiocbp;
	char aiocbp_r_[PADR_(uint32_t *)];
	char nent_l_[PADL_(int)];
	int nent;
	char nent_r_[PADR_(int)];
...
struct freebsd32_sigtimedwait_args {
	...
	char info_l_[PADL_(struct siginfo32 *)];
	struct siginfo32 *info;
	char info_r_[PADR_(struct siginfo32 *)];
	char timeout_l_[PADL_(const struct timespec32 *)];
	const struct timespec32 *timeout;
	char timeout_r_[PADR_(const struct timespec32 *)];
};
...
struct freebsd32_ksem_init_args {
	char idp_l_[PADL_(int32_t *)];
	int32_t *idp;
	char idp_r_[PADR_(int32_t *)];
...
struct freebsd32_sigaction_args {
	...
	char act_l_[PADL_(const struct sigaction32 *)];
	const struct sigaction32 *act;
	char act_r_[PADR_(const struct sigaction32 *)];
	char oact_l_[PADL_(struct sigaction32 *)];
	struct sigaction32 *oact;
	char oact_r_[PADR_(struct sigaction32 *)];
};
struct freebsd32_sigreturn_args {
	char sigcntxp_l_[PADL_(const struct __ucontext32 *)];
	const struct __ucontext32 *sigcntxp;
	char sigcntxp_r_[PADR_(const struct __ucontext32 *)];
};
struct freebsd32_getcontext_args {
	char ucp_l_[PADL_(struct __ucontext32 *)];
	struct __ucontext32 *ucp;
	char ucp_r_[PADR_(struct __ucontext32 *)];
};
struct freebsd32_setcontext_args {
	char ucp_l_[PADL_(const struct __ucontext32 *)];
	const struct __ucontext32 *ucp;
	char ucp_r_[PADR_(const struct __ucontext32 *)];
};
struct freebsd32_swapcontext_args {
	char oucp_l_[PADL_(struct __ucontext32 *)];
	struct __ucontext32 *oucp;
	char oucp_r_[PADR_(struct __ucontext32 *)];
	char ucp_l_[PADL_(const struct __ucontext32 *)];
	const struct __ucontext32 *ucp;
	char ucp_r_[PADR_(const struct __ucontext32 *)];
};
struct freebsd32_ksem_timedwait_args {
	char id_l_[PADL_(int32_t)];
	int32_t id;
	char id_r_[PADR_(int32_t)];
...
struct freebsd32_abort2_args {
	...
	char args_l_[PADL_(uint32_t *)];
	uint32_t *args;
	char args_r_[PADR_(uint32_t *)];
};
...
struct freebsd32_futimesat_args {
	...
	const char *path;
	char path_r_[PADR_(const char *)];
	char times_l_[PADL_(const struct timeval32 *)];
	const struct timeval32 *times;
	char times_r_[PADR_(const struct timeval32 *)];
};
...
struct freebsd32_wait6_args {
	...
	int options;
	char options_r_[PADR_(int)];
	char wrusage_l_[PADL_(struct __wrusage32 *)];
	struct __wrusage32 *wrusage;
	char wrusage_r_[PADR_(struct __wrusage32 *)];
	char info_l_[PADL_(struct siginfo32 *)];
	struct siginfo32 *info;
	char info_r_[PADR_(struct siginfo32 *)];
};
...
struct freebsd32_futimens_args {
	...
	int fd;
	char fd_r_[PADR_(int)];
	char times_l_[PADL_(const struct timespec32 *)];
	const struct timespec32 *times;
	char times_r_[PADR_(const struct timespec32 *)];
};
...
struct freebsd32_getfsstat_args {
	...
	char bufsize_l_[PADL_(int32_t)];
	int32_t bufsize;
	char bufsize_r_[PADR_(int32_t)];
	char mode_l_[PADL_(int)];
	int mode;
	char mode_r_[PADR_(int)];
};
...
struct freebsd32_timerfd_gettime_args {
	...
	int fd;
	char fd_r_[PADR_(int)];
	char curr_value_l_[PADL_(struct itimerspec32 *)];
	struct itimerspec32 *curr_value;
	char curr_value_r_[PADR_(struct itimerspec32 *)];
};
struct freebsd32_timerfd_settime_args {
	...
	int flags;
	char flags_r_[PADR_(int)];
	char new_value_l_[PADL_(const struct itimerspec32 *)];
	const struct itimerspec32 *new_value;
	char new_value_r_[PADR_(const struct itimerspec32 *)];
	char old_value_l_[PADL_(struct itimerspec32 *)];
	struct itimerspec32 *old_value;
	char old_value_r_[PADR_(struct itimerspec32 *)];
};
...
int freebsd32_gettimeofday(struct thread *,
    struct freebsd32_gettimeofday_args *);
...
int freebsd32_settimeofday(struct thread *,
    struct freebsd32_settimeofday_args *);
...
int freebsd32_clock_gettime(struct thread *,
    struct freebsd32_clock_gettime_args *);
int freebsd32_clock_settime(struct thread *,
    struct freebsd32_clock_settime_args *);
int freebsd32_clock_getres(struct thread *,
    struct freebsd32_clock_getres_args *);
int freebsd32_ktimer_create(struct thread *,
    struct freebsd32_ktimer_create_args *);
int freebsd32_ktimer_settime(struct thread *,
    struct freebsd32_ktimer_settime_args *);
int freebsd32_ktimer_gettime(struct thread *,
    struct freebsd32_ktimer_gettime_args *);
int freebsd32_nanosleep(struct thread *, struct freebsd32_nanosleep_args *);
int freebsd32_ffclock_setestimate(struct thread *,
    struct freebsd32_ffclock_setestimate_args *);
int freebsd32_ffclock_getestimate(struct thread *,
    struct freebsd32_ffclock_getestimate_args *);
int freebsd32_clock_nanosleep(struct thread *,
    struct freebsd32_clock_nanosleep_args *);
int freebsd32_clock_getcpuclockid2(struct thread *,
    struct freebsd32_clock_getcpuclockid2_args *);
...
int freebsd32_sched_rr_get_interval(struct thread *,
    struct freebsd32_sched_rr_get_interval_args *);
int freebsd32_jail(struct thread *, struct freebsd32_jail_args *);
int freebsd32_sigtimedwait(struct thread *,
    struct freebsd32_sigtimedwait_args *);
int freebsd32_sigwaitinfo(struct thread *, struct freebsd32_sigwaitinfo_args *);
int freebsd32_aio_waitcomplete(struct thread *,
    struct freebsd32_aio_waitcomplete_args *);
...
int freebsd32_ksem_timedwait(struct thread *,
    struct freebsd32_ksem_timedwait_args *);
...
int freebsd32_kmq_timedreceive(struct thread *,
    struct freebsd32_kmq_timedreceive_args *);
int freebsd32_kmq_timedsend(struct thread *,
    struct freebsd32_kmq_timedsend_args *);
...
int freebsd32_cpuset_setid(struct thread *,
    struct freebsd32_cpuset_setid_args *);
int freebsd32_cpuset_getid(struct thread *,
    struct freebsd32_cpuset_getid_args *);
int freebsd32_cpuset_getaffinity(struct thread *,
    struct freebsd32_cpuset_getaffinity_args *);
int freebsd32_cpuset_setaffinity(struct thread *,
    struct freebsd32_cpuset_setaffinity_args *);
...
int freebsd32_posix_fallocate(struct thread *,
    struct freebsd32_posix_fallocate_args *);
int freebsd32_posix_fadvise(struct thread *,
    struct freebsd32_posix_fadvise_args *);
int freebsd32_wait6(struct thread *, struct freebsd32_wait6_args *);
int freebsd32_cap_ioctls_limit(struct thread *,
    struct freebsd32_cap_ioctls_limit_args *);
int freebsd32_cap_ioctls_get(struct thread *,
    struct freebsd32_cap_ioctls_get_args *);
...
int freebsd32_cpuset_getdomain(struct thread *,
    struct freebsd32_cpuset_getdomain_args *);
int freebsd32_cpuset_setdomain(struct thread *,
    struct freebsd32_cpuset_setdomain_args *);
int freebsd32___sysctlbyname(struct thread *,
    struct freebsd32___sysctlbyname_args *);
...
int freebsd32_timerfd_gettime(struct thread *,
    struct freebsd32_timerfd_gettime_args *);
int freebsd32_timerfd_settime(struct thread *,
    struct freebsd32_timerfd_settime_args *);
...
struct ofreebsd32_lseek_args {
	...
	int fd;
	char fd_r_[PADR_(int)];
	char offset_l_[PADL_(int32_t)];
	int32_t offset;
	char offset_r_[PADR_(int32_t)];
	char whence_l_[PADL_(int)];
	int whence;
	char whence_r_[PADR_(int)];
};
...
struct ofreebsd32_fstat_args {
	...
	int fd;
	char fd_r_[PADR_(int)];
	char sb_l_[PADL_(struct ostat32 *)];
	struct ostat32 *sb;
	char sb_r_[PADR_(struct ostat32 *)];
};
struct ofreebsd32_mmap_args {
	...
	int fd;
	char fd_r_[PADR_(int)];
	char pos_l_[PADL_(int32_t)];
	int32_t pos;
	char pos_r_[PADR_(int32_t)];
};
...
struct ofreebsd32_recvmsg_args {
	...
	int s;
	char s_r_[PADR_(int)];
	char msg_l_[PADL_(struct omsghdr32 *)];
	struct omsghdr32 *msg;
	char msg_r_[PADR_(struct omsghdr32 *)];
	char flags_l_[PADL_(int)];
	int flags;
	char flags_r_[PADR_(int)];
};
struct ofreebsd32_sendmsg_args {
	...
	int s;
	char s_r_[PADR_(int)];
	char msg_l_[PADL_(const struct omsghdr32 *)];
	const struct omsghdr32 *msg;
	char msg_r_[PADR_(const struct omsghdr32 *)];
	char flags_l_[PADL_(int)];
	int flags;
	char flags_r_[PADR_(int)];
};
struct ofreebsd32_truncate_args {
	...
	const char *path;
	char path_r_[PADR_(const char *)];
	char length_l_[PADL_(int32_t)];
	int32_t length;
	char length_r_[PADR_(int32_t)];
};
...
struct ofreebsd32_sethostid_args {
	char hostid_l_[PADL_(int32_t)];
	int32_t hostid;
	char hostid_r_[PADR_(int32_t)];
};
...
int ofreebsd32_getdirentries(struct thread *,
    struct ofreebsd32_getdirentries_args *);
...
struct freebsd4_freebsd32_getfsstat_args {
	...
	char buf_r_[PADR_(struct ostatfs32 *)];
	char bufsize_l_[PADL_(int32_t)];
	int32_t bufsize;
	char bufsize_r_[PADR_(int32_t)];
	char mode_l_[PADL_(int)];
...
struct freebsd4_freebsd32_sigreturn_args {
	char sigcntxp_l_[PADL_(const struct freebsd4_ucontext32 *)];
	const struct freebsd4_ucontext32 *sigcntxp;
	char sigcntxp_r_[PADR_(const struct freebsd4_ucontext32 *)];
};
int freebsd4_freebsd32_getfsstat(struct thread *,
    struct freebsd4_freebsd32_getfsstat_args *);
int freebsd4_freebsd32_statfs(struct thread *,
    struct freebsd4_freebsd32_statfs_args *);
int freebsd4_freebsd32_fstatfs(struct thread *,
    struct freebsd4_freebsd32_fstatfs_args *);
int freebsd4_freebsd32_fhstatfs(struct thread *,
    struct freebsd4_freebsd32_fhstatfs_args *);
int freebsd4_freebsd32_sendfile(struct thread *,
    struct freebsd4_freebsd32_sendfile_args *);
int freebsd4_freebsd32_sigaction(struct thread *,
    struct freebsd4_freebsd32_sigaction_args *);
int freebsd4_freebsd32_sigreturn(struct thread *,
    struct freebsd4_freebsd32_sigreturn_args *);
...
int freebsd6_freebsd32_pread(struct thread *,
    struct freebsd6_freebsd32_pread_args *);
int freebsd6_freebsd32_pwrite(struct thread *,
    struct freebsd6_freebsd32_pwrite_args *);
int freebsd6_freebsd32_mmap(struct thread *,
    struct freebsd6_freebsd32_mmap_args *);
int freebsd6_freebsd32_lseek(struct thread *,
    struct freebsd6_freebsd32_lseek_args *);
int freebsd6_freebsd32_truncate(struct thread *,
    struct freebsd6_freebsd32_truncate_args *);
int freebsd6_freebsd32_ftruncate(struct thread *,
    struct freebsd6_freebsd32_ftruncate_args *);
int freebsd6_freebsd32_aio_read(struct thread *,
    struct freebsd6_freebsd32_aio_read_args *);
int freebsd6_freebsd32_aio_write(struct thread *,
    struct freebsd6_freebsd32_aio_write_args *);
int freebsd6_freebsd32_lio_listio(struct thread *,
    struct freebsd6_freebsd32_lio_listio_args *);
...
struct freebsd7_freebsd32___semctl_args {
	...
	int cmd;
	char cmd_r_[PADR_(int)];
	char arg_l_[PADL_(union semun_old32 *)];
	union semun_old32 *arg;
	char arg_r_[PADR_(union semun_old32 *)];
};
struct freebsd7_freebsd32_msgctl_args {
	...
	int cmd;
	char cmd_r_[PADR_(int)];
	char buf_l_[PADL_(struct msqid_ds_old32 *)];
	struct msqid_ds_old32 *buf;
	char buf_r_[PADR_(struct msqid_ds_old32 *)];
};
struct freebsd7_freebsd32_shmctl_args {
	...
	int cmd;
	char cmd_r_[PADR_(int)];
	char buf_l_[PADL_(struct shmid_ds_old32 *)];
	struct shmid_ds_old32 *buf;
	char buf_r_[PADR_(struct shmid_ds_old32 *)];
};
int freebsd7_freebsd32___semctl(struct thread *,
    struct freebsd7_freebsd32___semctl_args *);
int freebsd7_freebsd32_msgctl(struct thread *,
    struct freebsd7_freebsd32_msgctl_args *);
int freebsd7_freebsd32_shmctl(struct thread *,
    struct freebsd7_freebsd32_shmctl_args *);
...
struct freebsd10_freebsd32__umtx_lock_args {
	char umtx_l_[PADL_(struct umtx *)];
	struct umtx *umtx;
	char umtx_r_[PADR_(struct umtx *)];
};
...
int freebsd10_freebsd32__umtx_lock(struct thread *,
    struct freebsd10_freebsd32__umtx_lock_args *);
int freebsd10_freebsd32__umtx_unlock(struct thread *,
    struct freebsd10_freebsd32__umtx_unlock_args *);
...
struct freebsd11_freebsd32_nstat_args {
	...
	const char *path;
	char path_r_[PADR_(const char *)];
	char ub_l_[PADL_(struct nstat32 *)];
	struct nstat32 *ub;
	char ub_r_[PADR_(struct nstat32 *)];
};
struct freebsd11_freebsd32_nfstat_args {
	char fd_l_[PADL_(int)];
	int fd;
	char fd_r_[PADR_(int)];
	char sb_l_[PADL_(struct nstat32 *)];
	struct nstat32 *sb;
	char sb_r_[PADR_(struct nstat32 *)];
};
...
struct freebsd11_freebsd32_kevent_args {
	...
	int fd;
	char fd_r_[PADR_(int)];
	char changelist_l_[PADL_(const struct freebsd11_kevent32 *)];
	const struct freebsd11_kevent32 *changelist;
	char changelist_r_[PADR_(const struct freebsd11_kevent32 *)];
	char nchanges_l_[PADL_(int)];
	int nchanges;
	char nchanges_r_[PADR_(int)];
	char eventlist_l_[PADL_(struct freebsd11_kevent32 *)];
	struct freebsd11_kevent32 *eventlist;
	char eventlist_r_[PADR_(struct freebsd11_kevent32 *)];
	char nevents_l_[PADL_(int)];
	int nevents;
	char nevents_r_[PADR_(int)];
	char timeout_l_[PADL_(const struct timespec32 *)];
...
int freebsd11_freebsd32_stat(struct thread *,
    struct freebsd11_freebsd32_stat_args *);
int freebsd11_freebsd32_fstat(struct thread *,
    struct freebsd11_freebsd32_fstat_args *);
int freebsd11_freebsd32_lstat(struct thread *,
    struct freebsd11_freebsd32_lstat_args *);
int freebsd11_freebsd32_getdirentries(struct thread *,
    struct freebsd11_freebsd32_getdirentries_args *);
int freebsd11_freebsd32_nstat(struct thread *,
    struct freebsd11_freebsd32_nstat_args *);
int freebsd11_freebsd32_nfstat(struct thread *,
    struct freebsd11_freebsd32_nfstat_args *);
int freebsd11_freebsd32_nlstat(struct thread *,
    struct freebsd11_freebsd32_nlstat_args *);
int freebsd11_freebsd32_fhstat(struct thread *,
    struct freebsd11_freebsd32_fhstat_args *);
int freebsd11_freebsd32_kevent(struct thread *,
    struct freebsd11_freebsd32_kevent_args *);
int freebsd11_freebsd32_getfsstat(struct thread *,
    struct freebsd11_freebsd32_getfsstat_args *);
int freebsd11_freebsd32_fstatat(struct thread *,
    struct freebsd11_freebsd32_fstatat_args *);
