...
int gss_oid_equal(const gss_OID, /* first OID to compare */
    const gss_OID		 /* second OID to compare */
);

OM_uint32 gss_release_oid(OM_uint32 *, /* minor status */
    gss_OID *			       /* oid to free */
);

OM_uint32
gss_decapsulate_token(const gss_buffer_t, /* mechanism independent token */
    gss_OID,				  /* desired mechanism */
    gss_buffer_t /* decapsulated mechanism dependent token */
);

OM_uint32
gss_encapsulate_token(const gss_buffer_t, /* mechanism dependent token */
    gss_OID,				  /* desired mechanism */
    gss_buffer_t /* encapsulated mechanism independent token */
);

OM_uint32 gss_duplicate_oid(OM_uint32 *, /* minor status */
    const gss_OID,			 /* oid to copy */
    gss_OID *				 /* result */
);

OM_uint32 gss_oid_to_str(OM_uint32 *, /* minor status */
...
OM_uint32 gss_create_empty_buffer_set(OM_uint32 *, /* minor status */
    gss_buffer_set_t * /* location for new buffer set */
);

OM_uint32 gss_add_buffer_set_member(OM_uint32 *, /* minor status */
    gss_buffer_t,				 /* buffer to add */
    gss_buffer_set_t *				 /* set to add to */
);

OM_uint32 gss_release_buffer_set(OM_uint32 *, /* minor status */
...
OM_uint32 gss_set_sec_context_option(OM_uint32 *, /* minor status */
...
OM_uint32 gss_pseudo_random(OM_uint32 *, /* minor status */
